 ...
 * 
 * Multiple "t=" fields may be used if a session is active at multiple irregularly spaced times;
 * each additional "t=" field specifies an additional period of time for which the session will be
 * active. If the session is active at regular times, an "r=" field (see below) should be used in
 * addition to and following a "t=" field - in which case the "t=" field specifies the start and
...
public interface TimeDescription extends Serializable, Cloneable {
   ...
   * 
   * The value of this constant is 2208988800L. It can be used to convert between NTP and Java time
   * using the following formulas:
   * 
   * ntpTime = javaTime/1000 * SdpConstants.NTP_CONST; javaTime = (ntpTime - SdpConstants.NTP_CONST)
   * * 1000;
   * 
   * 
