...
public class SdpException extends Exception
{
	 ...
	 *            Codelet's normal operation, making this Codelet exception
	 *            necessary
	 */
	 ...
	 * 
	 * @param rootCause the system exception that makes this SdpException
	 *            necessary
	 */
	...
	/**
	 * Returns the Throwable system exception that makes this SdpException
	 * necessary.
	 * 
	 * @return Throwable
	 */
