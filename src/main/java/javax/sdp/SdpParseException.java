...
/**
 * The SdpParseException encapsulates the information thrown when an error occurs during SDP
 * parsing.
 * 
 * @author deruelle
 * @version 1.0
...
public class SdpParseException extends SdpException {
  ...
  /**
   * Constructs a new SdpParseException when the parser needs to throw an exception indicating a
   * parsing failure.
   * 
