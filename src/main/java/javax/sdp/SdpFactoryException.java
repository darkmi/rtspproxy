/*
 * SdpFactoryException.java Created on January 9, 2002, 6:44 PM
 */

package javax.sdp;

/**
 * The SdpFactoryException encapsulates the information thrown when a problem with configuration
 * with the SdpFactory exists. Please refer to IETF RFC 2327 for a description of SDP.
 * 
 * @author deruelle
 * @version 1.0
 */
...
public class SdpFactoryException extends SdpException {
  ...
  /**
   * Create a new FactoryConfigurationException with the given Exception base cause and detail
   * message.
   * 
   * @param msg msg - the detail message
   * @param ex ex - the "chained" exception
