/*
 * SessionDescription.java Created on January 10, 2002, 2:38 PM
 */
...
/**
 * A SessionDescription represents the data defined by the Session Description Protocol (see IETF
 * RFC 2327) and holds information about the originitor of a session, the media types that a client
 * can support and the host and port on which the client will listen for that media. The
 * SessionDescription also holds timing information for the session (e.g. start, end, repeat, time
 * zone) and bandwidth supported for the session. Please refer to IETF RFC 2327 for a description of
 * SDP.
 * 
 * @author deruelle
 * @version 1.0
