 ...
 * Protocol (see IETF RFC 2327) and holds information about the originitor of a
 * session, the media types that a client can support and the host and port on
 * which the client will listen for that media. The SessionDescription also
 * holds timing information for the session (e.g. start, end, repeat, time zone)
 * and bandwidth supported for the session. Please refer to IETF RFC 2327 for a
 * description of SDP.
 * 
 * @author deruelle
 * @version 1.0
...
public interface SessionDescription extends Serializable, Cloneable
{
	 ...
	 *        adjustments, where the key is the Adjusted Time Zone and the value
	 *        is the offset.
	 * @throws SdpException if the vector is null
	 */
