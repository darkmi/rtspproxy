...
public final class UnsignedLong extends UnsignedNumber {
	...
	@Override
	public int intValue() {
		return (((int) value[4] << 24) & 0xFF000000 | ((int) value[5] << 16) & 0xFF0000 | ((int) value[6] << 8)
				& 0xFF00 | ((int) value[7] & 0xFF));
	}

	@Override
	public long longValue() {
		return (((long) value[0] << 56) & 0xFF00000000000000L | ((long) value[1] << 48) & 0xFF000000000000L
				| ((long) value[2] << 40) & 0xFF0000000000L | ((long) value[3] << 32) & 0xFF00000000L
				| ((long) value[4] << 24) & 0xFF000000L | ((long) value[5] << 16) & 0xFF0000L | ((long) value[6] << 8)
