 ...
 * 
 * $URL:
 * http://svn.berlios.de/svnroot/repos/rtspproxy/tags/3.0-ALPHA2/src/main/java/rtspproxy/lib/number
 * /UnsignedLong.java $
 */
...
public final class UnsignedLong extends UnsignedNumber {
  ...
  public long longValue() {
    return (((long) value[0] << 56) & 0xFF00000000000000L | ((long) value[1] << 48)
        & 0xFF000000000000L | ((long) value[2] << 40) & 0xFF0000000000L | ((long) value[3] << 32)
        & 0xFF00000000L | ((long) value[4] << 24) & 0xFF000000L | ((long) value[5] << 16)
        & 0xFF0000L | ((long) value[6] << 8) & 0xFF00L | ((long) (value[7]) & 0xFFL));
  }
  ...
  public boolean equals(Object other) {
    if (other instanceof UnsignedLong) {
      ...
      for (int i = 7; i >= 0; i--)
        if (value[i] != bytes[i]) return false;
      return true;
