 ...
 * 
 * $URL:
 * http://svn.berlios.de/svnroot/repos/rtspproxy/tags/3.0-ALPHA2/src/main/java/rtspproxy/RtspService
 * .java $
 */
  ...
  public void start() throws IOException {
    ...
    if (netInterface == null) {
      for (int port : ports) {
        ...
        log.info("RtspService Started - Listening on: " + InetAddress.getByName(netInterface) + ":"
            + port);
      }
