...
/**
 * Handles RTP packets from clients arriving at the proxy public port. This is a special case,
 * because generally clients will not send any RTP packet (only RTCP).
 * 
 * @author Matteo Merli
 */
