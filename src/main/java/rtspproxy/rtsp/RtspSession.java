...
/**
 * RTSP is primarly a connection-less protocol, that means that RTSP request can be made over
 * multiples TCP connections. To identify such a "session", a 64-bit identifier is used.
 */
