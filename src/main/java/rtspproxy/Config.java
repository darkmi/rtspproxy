...
public class Config {
  ...
  protected Config() {
    ...
    if (rtspproxy_home == null) {
      ...
      if (rtspproxy_home == null) rtspproxy_home = "";
    }
    ...
    proxySignature =
        name + " " + version + " (" + System.getProperty("os.name") + " / "
    ...
    paths[4] =
        "src" + File.separator + "resources" + File.separator + "conf" + File.separator
  ...
  /**
   * Convert a list of comma separated integers string into an array of integers.
   * 
   * @param key
   * @param defaultValue
   * @return
