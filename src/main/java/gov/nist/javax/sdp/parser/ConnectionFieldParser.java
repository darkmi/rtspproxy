...
public class ConnectionFieldParser extends SDPParser {
  ...
  /**
   * public static void main(String[] args) throws ParseException { String connection[] = {
   * "c=IN IP4 224.2.17.12/127\n", "c=IN IP4 224.2.1.1/127/3 \n", "c=IN IP4 135.180.130.88\n" };
   * 
   * for (int i = 0; i < connection.length; i++) { ConnectionFieldParser connectionFieldParser= new
   * ConnectionFieldParser( connection[i] ); ConnectionField connectionField=connectionFieldParser.
   * connectionField(); System.out.println("toParse: " +connection[i]);
...
/*
 * $Log: ConnectionFieldParser.java,v $ Revision 1.2 2004/01/22 13:26:28 sverker Issue number:
