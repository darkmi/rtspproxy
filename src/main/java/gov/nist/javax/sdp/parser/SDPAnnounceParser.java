...
/*
 * $Log: SDPAnnounceParser.java,v $ Revision 1.5 2005/01/21 21:19:24 mranga Reviewed by: mranga
 * Strip leading whitespace while parsing Sdp Announce messages.
 * 
 * Revision 1.4 2004/02/18 14:33:02 mranga Submitted by: Bruno Konik Reviewed by: mranga Remove
 * extraneous newline in encoding messages. Test for empty sdp announce rather than die with null
 * when null is passed to sdp announce parser. Fixed bug in checking for \n\n when looking for
 * message end.
 * 
 * Revision 1.3 2004/01/22 13:26:28 sverker Issue number: Obtained from: Submitted by: sverker
 * Reviewed by: mranga
 * 
