...
public class ZoneFieldParser extends SDPParser {
  ...
  /**
   * public static void main(String[] args) throws ParseException { String zone[] = {
   * "z=2882844526 -1h 2898848070 0\n", "z=2886 +1h 2898848070 10 23423 -6s \n" };
   * 
   * for (int i = 0; i <zone.length; i++) { ZoneFieldParser zoneFieldParser=new ZoneFieldParser(
   * zone[i] ); ZoneField zoneField=zoneFieldParser.zoneField(); System.out.println("encoded: "
   * +zoneField.encode()); }
   * 
   * }
   **/
...
/*
 * $Log: ZoneFieldParser.java,v $ Revision 1.2 2004/01/22 13:26:28 sverker Issue number: Obtained
