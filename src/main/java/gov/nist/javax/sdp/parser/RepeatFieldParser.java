...
public class RepeatFieldParser extends SDPParser {
  ...
  /**
   * public static void main(String[] args) throws ParseException { String repeat[] = {
   * "r=604800s 3600s 0s 90000s\n", "r=7d 1h 0 25h\n", "r=7 6 5 4 3 2 1 0 \n" };
   * 
   * for (int i = 0; i < repeat.length; i++) { RepeatFieldParser repeatFieldParser=new
   * RepeatFieldParser( repeat[i] ); RepeatField repeatFields=repeatFieldParser.repeatField();
   * System.out.println("toParse: " +repeat[i]); System.out.println("encoded: "
   * +repeatFields.encode()); }
   * 
   * }
   **/
...
/*
 * $Log: RepeatFieldParser.java,v $ Revision 1.2 2004/01/22 13:26:28 sverker Issue number: Obtained
