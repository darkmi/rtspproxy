 ...
 *         the public domain.</a> Bug Report contributed by Brian J. Collins.
 */
...
public class TimeField extends SDPField implements Time {
  ...
  public String encode() {
    return new StringBuffer().append(TIME_FIELD).append(startTime).append(Separators.SP)
        .append(stopTime).append(Separators.NEWLINE).toString();
  }

}
/*
 * $Log: TimeField.java,v $ Revision 1.2 2004/01/22 13:26:27 sverker Issue number: Obtained from:
