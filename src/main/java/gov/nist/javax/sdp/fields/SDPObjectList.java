...
public class SDPObjectList extends GenericObjectList {
  ...
  public String encode() {
    ...
    SDPObject sdpObject;
    for (sdpObject = (SDPObject) this.first(); sdpObject != null; sdpObject =
        (SDPObject) this.next()) {
...
/*
 * $Log: SDPObjectList.java,v $ Revision 1.5 2005/04/16 20:38:45 dmuresan Canonical clone()
 * implementations for the GenericObject and GenericObjectList hierarchies Revision 1.4 2005/04/04
 * 10:01:28 dmuresan Used StringBuffer instead of String += for concatenation in various encode()
 * methods in javax.sdp. Revision 1.3 2004/01/22 13:26:27 sverker Issue number: Obtained from:
