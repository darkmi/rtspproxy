...
public class ZoneField extends SDPField implements javax.sdp.TimeZoneAdjustment {
  ...
  public String encode() {
    ...
    while (li.hasNext()) {
      ...
      if (num > 0) retval.append(Separators.SP);
  ...
  /**
   * Sets whether the field will be output as a typed time or a integer value. Typed time is
   * formatted as an integer followed by a unit character. The unit indicates an appropriate
   * multiplier for the integer. The following unit types are allowed. d - days (86400 seconds) h -
  ...
  /**
   * Returns whether the field will be output as a typed time or a integer value. Typed time is
   * formatted as an integer followed by a unit character. The unit indicates an appropriate
   * multiplier for the integer. The following unit types are allowed. d - days (86400 seconds) h -
   * hours (3600 seconds) m - minutes (60 seconds) s - seconds ( 1 seconds)
   * 
...
/*
 * $Log: ZoneField.java,v $ Revision 1.5 2005/04/16 20:38:45 dmuresan Canonical clone()
 ...
 * methods in javax.sdp. Revision 1.3 2004/01/22 13:26:28 sverker Issue number: Obtained from:
