...
public abstract class SDPFieldList extends SDPField {
  ...
  public Object clone() {
    ...
    if (this.sdpFields != null) retval.sdpFields = (SDPObjectList) this.sdpFields.clone();
    return retval;
  }
}
/*
 * $Log: SDPFieldList.java,v $ Revision 1.4 2005/04/16 20:38:44 dmuresan Canonical clone()
 * implementations for the GenericObject and GenericObjectList hierarchies
 * 
 * Revision 1.3 2005/04/04 10:01:28 dmuresan Used StringBuffer instead of String += for
