...
public class ConnectionField extends SDPField implements javax.sdp.Connection {
  ...
  public Object clone() {
    ...
    if (this.address != null) retval.address = (ConnectionAddress) this.address.clone();
    return retval;
  }

}
/*
 * $Log: ConnectionField.java,v $ Revision 1.3 2005/04/16 20:38:43 dmuresan Canonical clone()
