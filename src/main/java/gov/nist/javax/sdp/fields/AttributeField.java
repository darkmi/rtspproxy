...
public class AttributeField extends SDPField implements javax.sdp.Attribute {
  ...
  public Object clone() {
    ...
    if (this.attribute != null) retval.attribute = (NameValue) this.attribute.clone();
    return retval;
  }
}
/*
 * $Log: AttributeField.java,v $ Revision 1.3 2005/04/16 20:38:43 dmuresan Canonical clone()
