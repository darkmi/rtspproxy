...
public class SessionDescriptionImpl implements SessionDescription
{
	 ...
	 *            adjustments, where the key is the Adjusted Time Zone and the
	 *            value is the offset.
	 * @throws SdpException if the vector is null
	 */
...
/*
 * $Log: SessionDescriptionImpl.java,v $ Revision 1.6 2004/12/13 02:43:44 mranga
 * Submitted by: mranga Fix documentation bugs. Update change list. Revision 1.5
 * 2004/01/22 13:26:27 sverker Issue number: Obtained from: Submitted by:
 * sverker Reviewed by: mranga Major reformat of code to conform with style
 * guide. Resolved compiler and javadoc warnings. Added CVS tags. CVS:
 * ---------------------------------------------------------------------- CVS:
