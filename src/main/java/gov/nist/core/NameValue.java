...
public class NameValue extends GenericObject {
  ...
  /**
   * A flag that indicates that doublequotes should be put around the value when encoded (for
   * example name=value when value is doublequoted).
   */
  ...
  /**
   * Get the encoded representation of this namevalue object. Added doublequote for encoding
   * doublequoted values (bug reported by Kirby Kiem).
   * 
   * @since 1.0
...
/*
 * $Log: NameValue.java,v $ Revision 1.5 2005/04/16 20:38:42 dmuresan Canonical clone()
