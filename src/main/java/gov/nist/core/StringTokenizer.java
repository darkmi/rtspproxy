...
public class StringTokenizer
{
	...
	public static boolean isHexDigit( char ch )
	{
		if ( isDigit( ch ) )
			...
			return ch1 == 'A' || ch1 == 'B' || ch1 == 'C' || ch1 == 'D' || ch1 == 'E'
					|| ch1 == 'F';
		}
	}
...
/*
 * $Log: StringTokenizer.java,v $ Revision 1.5 2005/03/29 03:50:03 mranga Issue
 * number: Obtained from: Submitted by: mranga Remove transaction for early bye.
 * Reviewed by: CVS:
 * ---------------------------------------------------------------------- CVS:
 ...
 * this line. Revision 1.4 2004/01/22 13:26:27 sverker Issue number: Obtained
