...
/**
 * Implements a simple NameValue association with a quick lookup function (via a hash table) this
 * class is not thread safe because it uses HashTables.
 * 
...
/*
 * $Log: NameValueList.java,v $ Revision 1.5 2005/04/16 20:38:43 dmuresan Canonical clone()
