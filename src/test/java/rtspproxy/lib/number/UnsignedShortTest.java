...
public class UnsignedShortTest extends TestCase {
  ...
  public void test1() {
    ...
    assertTrue(Arrays.equals(new byte[] {(byte) 0xFF, (byte) 0xFF}, n.getBytes()));
  ...
  public void test5() {
    UnsignedShort n = UnsignedShort.fromBytes(new byte[] {(byte) 0xFF, (byte) 0xFF});
  ...
  public void test6() {
    ...
    UnsignedShort n4 = UnsignedShort.fromBytes(new byte[] {(byte) 0xFF, (byte) 0xFF});
