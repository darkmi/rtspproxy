 ...
 * 
 * $URL:
 * http://svn.berlios.de/svnroot/repos/rtspproxy/tags/3.0-ALPHA2/src/test/java/rtspproxy/lib/NptTest
 * .java $
 */
...
public class NptTest extends TestCase {
   ...
   * /* Test method for 'rtspproxy.lib.Npt.fromString(String)'
   * 
   * public void testFromString5() { String s = "npt=12:05:35.3-"; Npt npt = Npt.fromString( s );
   * 
   * assertNotNull( npt ); assertEquals( 12 * 3600 + 5 * 60 + 35.3, npt.getTimeStart() );
   * assertEquals( 0.0, npt.getTimeEnd() ); assertEquals( false, npt.isLive() ); assertEquals( s,
   * npt.toString() ); }
   */
}
